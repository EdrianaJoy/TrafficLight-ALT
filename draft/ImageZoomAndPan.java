...
//   1) public class ImageZoomAndPan   (with main(...))
...
public class ImageZoomAndPan {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            ImagePanel imagePanel = new ImagePanel("./img-map.png");
...
// ENUM: LightState
//
// The traffic light states: RED, GREEN, YELLOW. 
// ---------------------------------------------------------------------
enum LightState {
    RED, GREEN, YELLOW
}
...
//
// END OF FILE ImageZoomAndPan.java
// ---------------------------------------------------------------------