...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        JLabel imageLabel = new JLabel(new ImageIcon("src/main/resources/images/img-map.png"));
        ...
        ImageIcon trafficIcon = new ImageIcon("src/main/resources/images/traffic-light.png"); // Adjust path as needed
        ...
        nextButton.addActionListener(_ -> {
            ...
            SwingUtilities.invokeLater(() -> Prog.main(null));
        });
